...
![과제2 실행화면](img/login2-2.png)
  ...
  - **과제 내용**
      ...
      - 과제 실행화면 사진을 보면 기존의 로그인 성공 창은 그대로 작동하고 오류 발생 시에는 화면 내 텍스트로 에러 메시지가 나타나는 것을 확인할 수 있습니다.
  ...
  - **구현 내용과 기능 설명**
      ...
      - **사용자 경험 개선**: 로그인 실패 시 팝업 창과 화면 내 텍스트를 동시에 활용하여, 사용자가 문제를 명확히 인식하고 빠르게 수정할 수 있도록 돕는 UX 전략을 적용했습니다.
-----
